        ...
        if (!this.props.renderHiddenRow) {
            ...
            return (
                <SwipeRow
                    ...
                    setScrollEnabled={(enable) => this.setScrollEnabled(enable)}
                    leftOpenValue={
                        this.props.leftOpenValue != null ? this.props.leftOpenValue(rowData, secId, rowId, rowMap) : 0
                    }
                    rightOpenValue={
                        this.props.rightOpenValue != null ? this.props.rightOpenValue(rowData, secId, rowId, rowMap) : 0
                    }
